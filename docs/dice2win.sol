 ...
 *Submitted for verification at Etherscan.io on 2018-09-07,
 version upgraded from 0.4.24 to 0.8.12 on 2022-03-07                         
*/
...
contract Dice2Win {
    ...
    // fallback() be run just at times a function called at your contract that it doesn't exist there.
    ...
    function addr2uint(address a) internal pure returns (uint256) {
